// Script to populate PostgreSQL database with clean Amazon products

const { PrismaClient } = require('@prisma/client');

const prisma = new PrismaClient();

const cleanAmazonProducts = [
...
async function populatePostgreSQLDatabase() {
  try {
    console.log('🚀 Populating PostgreSQL database with clean Amazon products...');
    
    // Add products to database
    const result = await prisma.sponsoredProduct.createMany({
      data: cleanAmazonProducts,
      skipDuplicates: true
    });
    
    console.log(`✅ Successfully added ${result.count} products to PostgreSQL database`);
